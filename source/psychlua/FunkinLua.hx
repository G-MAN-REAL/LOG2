...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		Lua_helper.add_callback(lua, "cameraForceTarget", function(character:String){
		final point = PlayState.instance.generateCamPos(character);
		PlayState.instance.camFollow.setPosition(point.x, point.y);
		});
